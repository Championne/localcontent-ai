...
export const BLOG_STOCK_IMAGES: Record<string, string> = {
  ...
  demystifying_local_search_results_a_handbook_for_smb_owners: U('1527700812891-7c3e4d5f6a8b'),
  increase_foot_traffic_google_maps_local_pack: U('1527699723456-1a2b3c4d5e6f'),
  ...
  a_step_by_step_local_seo_checklist_for_businesses: U('1476983827163-8e9f0a1b2c3d'),
  driving_foot_traffic_online_digital_strategies_for_brick_and_mortar_success: U('1582214567890-9f0a1b2c3d4e'),

  // Marketing & community
  simple_email_marketing_strategies_for_local_businesses_that_convert: U('1593325678901-0a1b2c3d4e5f'),
  ...
  word_of_mouth_marketing_rekindle_the_oldest_growth_hack_for_smbs: U('1604436789012-1b2c3d4e5f6a'),
  ...
  creating_engaging_local_promotions_that_sell: U('1615547890123-2c3d4e5f6a7b'),
  seasonal_marketing_campaigns_ideas_for_local_businesses_all_year_round: U('1486234567890-3d4e5f6a7b8c'),
  hyperlocal_marketing_connecting_with_your_neighbors: U('1441986300917-64674bd600d8'),
  direct_mail_still_works_creative_strategies_for_local_businesses: U('1626658901234-4e5f6a7b8c9d'),
  forge_a_strong_local_brand_identity_in_the_digital_age: U('1517248135467-4c7edcad34c4'),
  '10_budget_friendly_marketing_ideas_for_local_business': U('1637769012345-5f6a7b8c9d0e'),
  ...
  beyond_text_using_ai_for_visual_and_video_content_for_smbs: U('1648870123456-6a7b8c9d0e1f'),
  personalize_at_scale_ai_powered_content_for_your_local_community: U('1659981234567-7b8c9d0e1f2a'),
  content_strategy_simplified_building_a_6_month_plan_with_ai: U('1660092345678-8c9d0e1f2a3b'),
  ...
  from_zero_to_published_your_first_ai_assisted_blog_post_guide: U('1671103456789-9d0e1f2a3b4c'),
  ethical_ai_content_how_local_businesses_ensure_authenticity: U('1682214567890-0e1f2a3b4c5d'),
  saving_time_and_money_the_roi_of_ai_in_local_content_creation: U('1460925895917-afdab827c52f'),
  ai_for_busy_business_owners_crafting_content_in_minutes_not_hours: U('1693325678901-1f2a3b4c5d6e'),
  the_essential_digital_toolkit_for_every_growing_small_business: U('1556761175-b413da4baf72'),

  // Business growth & data
  understand_your_local_customer_base_with_data_driven_insights: U('1704436789012-2a3b4c5d6e7f'),
  ...
  customer_journey_mapping_optimizing_your_local_buyer_s_path: U('1715547890123-3b4c5d6e7f8a'),
  small_business_automation_tools_to_streamline_your_operations: U('1556761175-b413da4baf72'),
  subscription_models_for_smbs_building_recurring_local_revenue: U('1726658901234-4c5d6e7f8a9b'),
  future_proofing_your_local_business_adapting_to_digital_trends: U('1737769012345-5d6e7f8a9b0c'),
  e_commerce_for_local_shops_setting_up_your_online_storefront: U('1748870123456-6e7f8a9b0c1d'),
  digital_payment_solutions_modernizing_your_local_business_transactions: U('1759981234567-7f8a9b0c1d2e'),
}
