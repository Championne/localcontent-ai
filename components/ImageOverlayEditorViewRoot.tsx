          ...
          <div
            ...
            style={{
              ...
              ...(p.frame?.style === 'polaroid'
                ...
                : {
                    padding: p.frame
                      ? (p.frame.style === 'thin' ? 3
                        : p.frame.style === 'classic' || p.frame.style === 'wooden' ? 20
                        : p.frame.style === 'thick' || p.frame.style === 'gold' || p.frame.style === 'silver' || p.frame.style === 'copper' ? 16
                        : p.frame.style === 'filmstrip' ? 32
                        : p.frame.style === 'neon' ? 32
                        : p.frame.style === 'shadow' ? 40
                        : p.frame.style === 'vignette' ? 0
                        : 8)
                      : 0,
                  }),
              ...(p.frame?.style === 'classic'
                ...
                : {
                    backgroundColor: p.frame
                      ? (p.frame.style === 'polaroid' ? 'transparent'
                        : p.frame.style === 'filmstrip' ? '#121212'
                        : p.frame.style === 'neon' ? '#0a0a0e'
                        : p.frame.style === 'shadow' ? '#f5f7fa'
                        : p.frame.style === 'vignette' ? undefined
                        : p.getFrameHex(p.frame.colorKey))
                      : undefined,
                  }),
            ...
            <div
              ...
              style={{
                ...
                ...(p.frame?.style === 'double'
                  ...
                  : {}),
                ...(p.frame?.style !== 'double' && {
                  border: p.frame?.style === 'classic' || p.frame?.style === 'wooden'
                    ? undefined
                    : p.frame?.style === 'gold' ? '2px solid rgba(255,248,220,0.9)'
                    : p.frame?.style === 'silver' ? '2px solid rgba(255,255,255,0.95)'
                    : p.frame?.style === 'copper' ? '2px solid rgba(253,240,224,0.9)'
                    : p.frame?.style === 'dashed' ? `3px dashed ${p.frame ? p.getFrameHex(p.frame.colorKey) : '#e5e7eb'}`
                    : p.frame?.style === 'dotted' ? `3px dotted ${p.frame ? p.getFrameHex(p.frame.colorKey) : '#e5e7eb'}`
                    : p.frame?.style === 'polaroid' ? 'none'
                    : p.frame?.style === 'filmstrip' ? '1px solid #2a2a2a'
                    : undefined,
                }),
                boxShadow: p.frame?.style === 'classic' ? 'inset 0 0 0 2px rgba(255,255,255,0.5)'
                  : p.frame?.style === 'wooden' ? 'inset 0 0 0 1px rgba(0,0,0,0.15)'
                  : p.frame?.style === 'shadow' ? '0 24px 48px rgba(0,0,0,0.4), 0 12px 24px rgba(0,0,0,0.25)'
                  : p.frame?.style === 'neon'
                    ? `0 0 40px ${p.frame ? p.getFrameHex(p.frame.colorKey) : '#0d9488'}, 0 0 20px ${p.frame ? p.getFrameHex(p.frame.colorKey) : '#0d9488'}99, 0 0 8px ${p.frame ? p.getFrameHex(p.frame.colorKey) : '#0d9488'}`
                  : p.frame?.style === 'gold' ? 'inset 0 1px 0 rgba(255,252,224,0.9), inset 0 3px 8px -2px rgba(255,255,255,0.35), inset 0 -2px 0 rgba(0,0,0,0.25)'
                  : p.frame?.style === 'silver' ? 'inset 0 1px 0 rgba(255,255,255,0.98), inset 0 3px 8px -2px rgba(255,255,255,0.4), inset 0 -2px 0 rgba(0,0,0,0.3)'
                  : p.frame?.style === 'copper' ? 'inset 0 1px 0 rgba(253,245,235,0.95), inset 0 3px 8px -2px rgba(255,248,235,0.25), inset 0 -2px 0 rgba(0,0,0,0.25)'
                  : p.frame?.style === 'polaroid' ? 'none'
                  : undefined,
              }}
            >
